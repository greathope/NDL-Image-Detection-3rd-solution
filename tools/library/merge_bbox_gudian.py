...
# all data
json_file_list = [
    'data/fuxian/output/gudian/2264.pkl.bbox.json',
    'data/fuxian/output/gudian/2265.pkl.bbox.json',
    'data/fuxian/output/gudian/2266.pkl.bbox.json',
    'data/fuxian/output/gudian/1311.pkl.bbox.json',
    'data/fuxian/output/gudian/1312.pkl.bbox.json',
    'data/fuxian/output/gudian/1313.pkl.bbox.json',
    'data/fuxian/output/gudian/2021.pkl.bbox.json',
    'data/fuxian/output/gudian/2022.pkl.bbox.json',
]
result_file = 'data/merge_all_gudian.json'
